            ...
            {selectedExercise && (
                <div className="flex flex-col justify-center items-center m-10">
                    <div className="border border-gray-300 rounded-lg p-8 shadow-md bg-gray-400">
                        <div className="mb-4">
                            <p className="text-lg font-semibold mb-1">Nombre: <span className="font-normal">{selectedExercise.name}</span></p>
                            <p className="text-lg font-semibold mb-1">Descripción: <span className="font-normal">{selectedExercise.description}</span></p>
                            <p className="text-lg font-semibold mb-1">Músculo: <span className="font-normal">{selectedExercise.muscle?.name}</span></p>
                        </div>
