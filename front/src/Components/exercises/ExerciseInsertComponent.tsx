        ...
        <div className="flex flex-col justify-center items-center">
            ...
            <div className="border border-gray-300 rounded-lg p-8 shadow-md bg-gray-400 flex flex-col items-center">
                <div className="flex flex-col mb-4">
                    ...
                    <input type="text" value={newExerciseName} onChange={e => setNewExerciseName(e.target.value)} className="border border-gray-400 rounded-lg px-4 py-2 w-72 focus:outline-none focus:border-blue-500" />
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="exerciseDescription" className="text-lg font-semibold mb-1">Descripción del Ejercicio:</label>
                    <input type="text" value={newExerciseDescription} onChange={e => setNewExerciseDescription(e.target.value)} className="border border-gray-400 rounded-lg px-4 py-2 w-72 focus:outline-none focus:border-blue-500" />
                </div>
                <div className="flex flex-col mb-4">
                    <label htmlFor="muscleSelect" className="text-lg font-semibold mb-1">Seleccionar Músculo:</label>
                    <select id="muscleSelect" value={selectedMuscleId || ''} onChange={e => setSelectedMuscleId(parseInt(e.target.value))} className="border border-gray-400 rounded-lg px-4 py-2 w-72 focus:outline-none focus:border-blue-500">
                ...
                <div className="flex flex-row justify-center gap-12 items-center">
                    <button className="w-36 h-12 rounded-lg text-xl text-white bg-green-700 hover:bg-green-600 mr-4" onClick={handleAddExercise}>Anadir</button>
                    <Link to="/exercises">
                        <button className="w-36 h-12 rounded-lg text-xl text-white bg-red-700 hover:bg-red-600">Volver</button>
                    </Link>
                </div>
            </div>
        </div>
