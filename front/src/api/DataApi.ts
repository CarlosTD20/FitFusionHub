...
export const fetchData = async <T>(type: string): Promise<T[]> => {
  try {
...
export const fetchItemById = async <T>(type: string, id: number): Promise<T | null> => {
    try {
...
export const addItem = async <T>(type: string, newItem: T): Promise<void> => {
  try {
...
export const updateItem = async <T>(type: string, id: number, newValue: T): Promise<void> => {
  try {
