        ...
        <div>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-[22px] pt-[8px] m-[14px]">
                <div className="h-[268px] w-[396px] rounded-[24px flex flex-col">
                    <div className="w-[396px] h-[202px] rounded-[24px] bg-fit-b" style={{ backgroundImage: 'url(https://s3-alpha-sig.figma.com/img/9bf1/1e8c/ce46b21b01a20bf640d2f24c8e4cfc8f?Expires=1715558400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=hfmQvIUg1U~P0a~JwMzmcbEsPRRk-LfAk9iE9QRhV3xQGJEuV92wVGxNkgz5eLK8dPiIpe2rCOevD9SExn82t7lo2eSkh-zCDZxdiAJ4Aox2x4HODfKnhJE3K-73ZvaGdUAHzgPjALy2sc-ZpW0sLPidsoK~d7DSG4kPARtFVPWqaLirgZ-PPZeIy3S-1jZwTDwvydIyCSIpRo71Zpa5Qkm1wsJem7PuMET07ULEkRdByw-NeoG-6MkI1Vqp8tA6aXWypu4NwIZa9n89IDGAt6XW0f~rL8Ekn4It8XUB~m11lDKipt975pnFPYvNtOsL1zMrElrtiYRwtINIg1lNsw__)' }}></div>
                    <div className="flex flex-row justify-between m-[8px]">
                        <Link to="/exercises" className="w-[153px] h-[56px] rounded-[18px] bg-fit-o flex items-center justify-center text-white font-semibold font-archivo">Ver Ejercicios</Link>
                ...
                <div className="h-[268px] w-[396px] rounded-[24px flex flex-col">
                    <div className="w-[396px] h-[202px] rounded-[24px] bg-fit-b" style={{ backgroundImage: 'url(https://s3-alpha-sig.figma.com/img/69b4/16ef/d813e3a7a6f9686b3555ae4e84dbfb8c?Expires=1715558400&Key-Pair-Id=APKAQ4GOSFWCVNEHN3O4&Signature=Igq0ToRYaf3sbSXBvrAVM5b7an7g5B9ukeFNY1eFkAoczQPMsq7R3nVGANNlv2a4SFSK2yymaFwKn9HjK9StYZPvpkeYUaDGoXE9MzApbZ7T6LN5S2EaIE~bpRMG85v1YXFxvoSClAvgMdWo-9u8IGZTjeAM0dkyobedHIcmoY7aDlRg4AIAn9Y-vGTMKIA~6yOjlqBE6aQSOQE-aGzTuBJVIZLjSxyJCf5ogjnRzFEBv8oNFJs4SaBEIeNobrPLEVuXo0o74MUlICdd4M1yMKzjKie4RHS8kDiZU7Q~egUyi9Mit2hXa1XN8MbB22AwbpMRoXdgHeG2obJXUVQJOQ__)' }}></div>
                    <div className="flex flex-row justify-between m-[8px]">
                        <Link to="/routines" className="w-[153px] h-[56px] rounded-[18px] bg-fit-o flex items-center justify-center text-white font-semibold font-archivo">Ver Rutinas</Link>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-[22px] pt-[8px] m-[14px] ">
                <div className="w-[396px] md:w-[1224px] p-[24px] h-[214px] rounded-[24px] bg-fit-o flex flex-col md:flex-row md:justify-around">
                    ...
                    <div className="flex items-center justify-center gap-[12px]">
                        <input type="email" className="h-[67px] w-[409px] rounded-[18px] bg-fit-w" placeholder="Ingresa tu correo electrónico" value={correo}
